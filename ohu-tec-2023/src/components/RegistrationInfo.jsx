...
function RegistrationInfo() {
    return (
        <div id="registration" className="flex flex-col justify-center items-center font-Poppins md:flex-row mt-10 mx-1 md:mx-5 lg:mx-10 mb-10">
            <img src={image} className="w-40 h-40 rounded-full sm:w-60 sm:h-60" />
            <div>
                <h3 className="px-7 text-lg mt-3 sm:text-2xl md:text-3xl  lg:text-4xl">More Than <span className="font-bold">670+ registrants</span> last year, TEC managed to ...</h3>
